...
source("https://raw.githubusercontent.com/harrisoncassel/wbb-markov/main/R/transition_matrix.R?token=GHSAT0AAAAAACAJ3F4DJGRZJANEN3TPWQJEZCB2E4Q")
```
...
source('https://raw.githubusercontent.com/harrisoncassel/wbb-markov/main/R/data_management.R?token=GHSAT0AAAAAACAJ3F4CH2SAJVHB3TCN5PJAZCB2FOQ')
...
#gamecocks.pbp <- readRDS(gzcon(url("https://github.com/harrisoncassel/wbb-markov/blob/cab0596ca63af0582bd0135362bcda1f3205c793/R/helper_data/gamecocks_23_pbp.rds?token=GHSAT0AAAAAACAJ3F4CH2SAJVHB3TCN5PJAZCB2FOQ")))
#trans.mat <- readRDS(gzcon(url("https://github.com/harrisoncassel/wbb-markov/raw/simulations_section/R/helper_data/trans_mat.rds?token=GHSAT0AAAAAACAJ3F4CH2SAJVHB3TCN5PJAZCB2FOQ")))
```
...
source('https://raw.githubusercontent.com/harrisoncassel/wbb-markov/main/R/simulations.R?token=GHSAT0AAAAAACAJ3F4CC2G7557CGOPEDPWOZCB2MSA')
...
# Load diagnostics.R
source('https://raw.githubusercontent.com/harrisoncassel/wbb-markov/main/R/diagnostics.R?token=GHSAT0AAAAAACAJ3F4CRI7F3B2MEB5QX3ACZCB2NEA')
...
Clearly, this model exhibits a strong ability to accurately simulate Gamecocks basketball, at least in this most recent season! The "defensive" (Team B) predictions are impressively accurate. This is what we expected, and it confirms that this is an effective model for simulating the 2022-23 Gamecocks. Its predictions matched the reality on which it was trained.

Below are the coefficient of variation results for another dominant team, the Iowa Hawkeyes, using a function that packages a few of the sections above into one. They are certainly less impressive than those
...
saveRDS(results.cv, 'results_cv.rds')

saveRDS(results.diff, 'comparison_diff.rds')
